...
export function ExpenseForm() {
    ...
    const [loading, setLoading] = useState(false); // Track loading state for categories
    ...
    // Trigger fetchCategories when dropdown is opened
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.error("Error adding transaction:", data.error, data);
            }
        } catch (error) {
